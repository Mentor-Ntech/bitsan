    ...
    <>
      <header className="main__header">
        <div className="container main__header-container">
          <div className="main__header-left">
            ...
            <h3>
              Superior fast payment and settlement <br />
              infrastructure to accept cross-border payment <br />
              from customers. On web and mobile
            </h3>
      ...
      <section>
        ...
        <div className="checkout__wrapper">
          {checkout.map(({ id, icon, title, desc }) => {
            return (
              <Card className="checkouts__checkout">
                <span>{icon}</span>
                <h4>{title}</h4>
                <small>{desc}</small>
              </Card>
      ...
      <section className="platform__story">
        ...
        <div className="platform__section-content">
          ...
          <h3>
            Accept payment from a wide variety of option <br />
            including Binance USD, Celo CUSDT, USDC <br />
            Stablecoin and all other coin
          </h3>
        </div>
      </section>
      ...
      <section className="platform__story">
        ...
        <div className="platform__section-content">
          ...
          <h3>
            Send payments from your Bitsans account to <br />
            cryptocurrency of your choice. <br />
            Want to withdraw to your local bank instead? We got that too
          </h3>
        </div>
      </section>
    </>
